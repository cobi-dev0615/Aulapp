        ...
        try {
            if (objArr2 != null) {
                ...
                if (j2 > j) {
                    ...
                    int c = a.c((~(elapsedCpuTime | 788398050)) | (~((~elapsedCpuTime) | (-750349795))) | 213412258, 168, ((~((-536937537) | elapsedCpuTime)) * 168) + ((((~(251460514 | r5)) | 536937536) * 168) - 1710130969), 2043399137);
                    int i = c ^ (c << 13);
                    int i2 = i ^ (i >>> 17);
        ...
        try {
            try {
                if (objArr2 != null) {
                    ...
                    if (j2 > j) {
                        objArr = new Object[]{new long[]{((long[]) objArr2[0])[0]}, new int[1]};
                        int c = a.c(~(System.identityHashCode(this) | (-136858633)), -1504, (((~((-136990281) | r0)) | 131648) * 1504) - 1003693777, -2129266090);
                        int i = c ^ (c << 13);
                        int i2 = i ^ (i >>> 17);
                        ((int[]) objArr[1])[0] = i2 ^ (i2 << 5);
            ...
            byte b2 = bArr[27];
            Object[] objArr3 = new Object[1];
            k(b, b2, (byte) (b2 | 28), objArr3);
            Class<?> cls = Class.forName((String) objArr3[0]);
            byte b3 = bArr[27];
            Object[] objArr4 = new Object[1];
            k(b3, bArr[77], b3, objArr4);
            objArr = (Object[]) cls.getMethod((String) objArr4[0], Integer.TYPE).invoke(null, 861116742);
            j = ((long[]) objArr[0])[0];
            ((long[]) objArr[0])[0] = j + 5013;
            Fpnative.valueOf = objArr;
            jSONObject = new JSONObject();
