        ...
        try {
            if (objArr2 != null) {
                ...
                if (j2 > j) {
                    ...
                    int i11 = i10 >> 19;
                    int a = b.a(i11 & (-16383), i11 | (-16383), ConstantsKt.DEFAULT_BUFFER_SIZE, -1);
                    ...
                    this.PngjExceptionInternal = b.c(i15 & (-(((i17 | 1) << 1) - (i17 ^ 1))), 1009, 45405, "2,31,");
            ...
            int i112 = i102 >> 19;
            int a2 = b.a(i112 & (-16383), i112 | (-16383), ConstantsKt.DEFAULT_BUFFER_SIZE, -1);
            ...
            this.PngjExceptionInternal = b.c(i152 & (-(((i172 | 1) << 1) - (i172 ^ 1))), 1009, 45405, "2,31,");
            this.PngjUnsupportedException = new ArrayList();
            this.PngBadCharsetException = new HashMap();
            this.a = new HashMap();
            this.getPadSub2 = 0.0d;
        ...
        try {
            if (objArr2 != null) {
                ...
                if (j2 > j) {
                    ...
                    int i8 = i7 >> 15;
                    int a = b.a(i8 & (-262143), i8 | (-262143), 131072, -1);
                    int i9 = (i7 & a) + (a | i7);
                    int i10 = i7 >> 21;
                    int i11 = -(b.e((i10 | (-4095)) << 1, i10 ^ (-4095), 2048, -1) ^ i9);
            ...
            int i82 = i72 >> 15;
            int a2 = b.a(i82 & (-262143), i82 | (-262143), 131072, -1);
            int i92 = (i72 & a2) + (a2 | i72);
            int i102 = i72 >> 21;
            int i112 = -(b.e((i102 | (-4095)) << 1, i102 ^ (-4095), 2048, -1) ^ i92);
        ...
        try {
            if (objArr2 != null) {
                ...
                if (j2 > j) {
                    ...
                    int i11 = i10 >> 23;
                    int e = b.e((i11 | (-1023)) << 1, i11 ^ (-1023), ConstantsKt.MINIMUM_BLOCK_SIZE, -1);
                    int i12 = -(b.e(i10 >> 16, 131071, 65536, -1) ^ ((i10 ^ e) + ((e & i10) << 1)));
                    int i13 = (i12 & 6) + (i12 | 6);
                    int i14 = i13 >> 18;
            ...
            int i112 = i102 >> 23;
            int e2 = b.e((i112 | (-1023)) << 1, i112 ^ (-1023), ConstantsKt.MINIMUM_BLOCK_SIZE, -1);
            int i122 = -(b.e(i102 >> 16, 131071, 65536, -1) ^ ((i102 ^ e2) + ((e2 & i102) << 1)));
