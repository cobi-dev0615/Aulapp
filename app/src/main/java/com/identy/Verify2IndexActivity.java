    ...
    public class PngjBadCrcException implements PngjBadSignature.values {
        ...
        */
        public final void values() {
            ...
            Verify2IndexActivity verify2IndexActivity = Verify2IndexActivity.this;
            int i = verify2IndexActivity.PngjBadCrcException + 1;
            verify2IndexActivity.PngjBadCrcException = i;
            if (i == this.PngjBadCrcException.size() && FingerActivity.PngjPrematureEnding) {
                VerifyResult verifyResult3 = null;
                try {
                    HashMap hashMap = new HashMap();
                    for (Map.Entry entry : this.PngjBadCrcException.entrySet()) {
                        hashMap.put(Integer.valueOf(Position.getFromHandFinger((Pair) entry.getKey()).ordinal()), ((PngjExceptionInternal) Verify2IndexActivity.this.valueOf.get(entry.getKey())).PngjBadCrcException());
                    }
                    matchCaptured = Fpnative.matchCaptured(e1.values, hashMap, this.valueOf.ordinal());
                } catch (Exception e) {
                    e = e;
                }
                if (matchCaptured == null) {
                    return;
                }
                try {
                    VerifyResult verifyResult4 = null;
                    for (Map.Entry entry2 : this.PngjBadCrcException.entrySet()) {
                        try {
                            verifyResult4 = new VerifyResult(matchCaptured.getEnrollmentTs());
                            verifyResult4.setMatched(matchCaptured.isMatched());
                            verifyResult4.positionMismatched = matchCaptured.positionMismatched;
                            verifyResult4.setMatched_true_up_to_security_level(matchCaptured.matched_true_up_to_security_level);
                            verifyResult4.setScore((int) Math.round(matchCaptured.getScore()));
                            getProcessingTime getprocessingtime = (getProcessingTime) entry2.getValue();
                            getprocessingtime.PngjBadCrcException(matchCaptured.isMatched());
                            ((a) getprocessingtime).values = Math.round(matchCaptured.getFingerScore((Pair) entry2.getKey()));
                            Verify2IndexActivity.this.onErrorResponse.Capture2IndexActivity.PngjBadSignature.put((Pair) entry2.getKey(), Integer.valueOf(((a) getprocessingtime).values));
                        } catch (Exception e2) {
                            e = e2;
                            verifyResult3 = matchCaptured;
                            try {
                            ...
                            int i2 = IdentySdk.getInstance().getAllowedAttempts();
                            e1Var = Verify2IndexActivity.this.onErrorResponse;
                            e1Var.getEncryptedTemplates++;
                            if (!((a) this.PngjBadCrcException.get(e1Var.PngjExceptionInternal()[0])).PngjOutputException()) {
                            }
                        }
                    }
                    Verify2IndexActivity.this.onErrorResponse.Capture2IndexActivity.getFingerPrintQualityScore = matchCaptured.isMatched() ? 1 : 2;
                    try {
                        Verify2IndexActivity.this.onErrorResponse.valueOf();
                    } catch (Exception e4) {
                        try {
                            if (LibSettings.isSaveCaptured()) {
                                e4.getMessage();
                    ...
                    e1.values(new Object[]{Verify2IndexActivity.this.onErrorResponse}, com.identy.i.PngjPrematureEnding.values(), com.identy.i.PngjPrematureEnding.values(), -431637600, com.identy.i.PngjPrematureEnding.values(), 431637601, com.identy.i.PngjPrematureEnding.values());
                    IdentySdk identySdk = IdentySdk.getInstance();
                    Verify2IndexActivity verify2IndexActivity2 = Verify2IndexActivity.this;
                    FingerDetectionMode fingerDetectionMode = verify2IndexActivity2.PngjExceptionInternal;
                    e1 e1Var2 = verify2IndexActivity2.onErrorResponse;
                    int i3 = e1Var2.getEncryptedTemplates;
                    HashMap hashMap2 = this.PngjBadCrcException;
                    long j = e1Var2.toString;
                    long j2 = e1Var2.Enroll2IndexActivity;
                    verifyResult2 = matchCaptured;
                    try {
                        long timeInMillis = Calendar.getInstance().getTimeInMillis() - this.PngjBadSignature;
                        byte[] PngjPrematureEnding = Verify2IndexActivity.this.onErrorResponse.PngjPrematureEnding();
                        e1 e1Var3 = Verify2IndexActivity.this.onErrorResponse;
                        identySdk.a(fingerDetectionMode, i3, hashMap2, verifyResult4, j, j2, timeInMillis, PngjPrematureEnding, e1Var3.setFoundMatchingTemplates + e1Var3.Enroll2IndexActivity);
                        verifyResult = verifyResult2;
                    } catch (Exception e6) {
                        e = e6;
                        ...
                        verifyResult = verifyResult3;
                        int i22 = IdentySdk.getInstance().getAllowedAttempts();
                        e1Var = Verify2IndexActivity.this.onErrorResponse;
                        e1Var.getEncryptedTemplates++;
                        if (!((a) this.PngjBadCrcException.get(e1Var.PngjExceptionInternal()[0])).PngjOutputException()) {
                        }
                    ...
                    verifyResult = verifyResult3;
                    int i222 = IdentySdk.getInstance().getAllowedAttempts();
                    e1Var = Verify2IndexActivity.this.onErrorResponse;
                    e1Var.getEncryptedTemplates++;
                    if (!((a) this.PngjBadCrcException.get(e1Var.PngjExceptionInternal()[0])).PngjOutputException()) {
                    }
                }
                int i2222 = IdentySdk.getInstance().getAllowedAttempts();
                e1Var = Verify2IndexActivity.this.onErrorResponse;
                e1Var.getEncryptedTemplates++;
                if (!((a) this.PngjBadCrcException.get(e1Var.PngjExceptionInternal()[0])).PngjOutputException()) {
                    Verify2IndexActivity verify2IndexActivity3 = Verify2IndexActivity.this;
                    if (verify2IndexActivity3.onErrorResponse.getEncryptedTemplates < i2222) {
                        verify2IndexActivity3.e1();
                        return;
                    }
                    try {
                        if (IdentySdk.getInstance().isDisplayTransactionAlerts()) {
                            com.identy.ui.c.a aVar = new com.identy.ui.c.a(Verify2IndexActivity.this);
                            aVar.PngjBadSignature = R.string.id_spoof_final_message;
                            aVar.PngjException = R.string.id_done;
                            aVar.values(new values()).show();
                        } else {
                            Verify2IndexActivity verify2IndexActivity4 = Verify2IndexActivity.this;
                            verify2IndexActivity4.values((Pair<Hand, Finger>[]) verify2IndexActivity4.onErrorResponse.PngjExceptionInternal());
                        }
                        return;
                    } catch (Exception e8) {
                        e8.printStackTrace();
                ...
                try {
                    ...
                    if (!valueof2.equals(valueOf.RETAKE)) {
                        try {
                            Verify2IndexActivity.this.Action.PngjException();
                        } catch (Exception unused) {
                        }
                    }
                    if (IdentySdk.getInstance().isDisplayPrints()) {
                        Verify2IndexActivity verify2IndexActivity5 = Verify2IndexActivity.this;
                        Verify2IndexActivity verify2IndexActivity6 = Verify2IndexActivity.this;
                        verify2IndexActivity5.getPadSub1 = new com.identy.ui.c.values(verify2IndexActivity6, this.PngjBadCrcException, this.PngjException, valueof2, verify2IndexActivity6.getQualityScore);
                        Verify2IndexActivity.this.getPadSub1.show();
                        return;
                    }
                    if (!IdentySdk.getInstance().v()) {
                        if (IdentySdk.getInstance().isDisplayMoveNextDialog()) {
                            Verify2IndexActivity.this.Attempt();
                            return;
                        } else {
                            Verify2IndexActivity.this.Action();
                            return;
                        }
                    }
                    if (valueof2.equals(valueOf.RETAKE)) {
                        Verify2IndexActivity verify2IndexActivity7 = Verify2IndexActivity.this;
                        Verify2IndexActivity verify2IndexActivity8 = Verify2IndexActivity.this;
                        verify2IndexActivity7.getPadSub1 = new com.identy.ui.c.getScore(verify2IndexActivity8, verify2IndexActivity8.getQualityScore);
                    } else if (valueof2.equals(valueOf.UNSUCCESS)) {
                        Verify2IndexActivity verify2IndexActivity9 = Verify2IndexActivity.this;
                        Verify2IndexActivity verify2IndexActivity10 = Verify2IndexActivity.this;
                        verify2IndexActivity9.getPadSub1 = new com.identy.ui.c.isQualityFailed(verify2IndexActivity10, verify2IndexActivity10.getQualityScore);
                    } else {
                        Verify2IndexActivity verify2IndexActivity11 = Verify2IndexActivity.this;
                        Verify2IndexActivity verify2IndexActivity12 = Verify2IndexActivity.this;
                        verify2IndexActivity11.getPadSub1 = new com.identy.ui.c.getFingerPrintQualityScore(verify2IndexActivity12, verify2IndexActivity12.getQualityScore, verify2IndexActivity12.PngjExceptionInternal, verify2IndexActivity12.onErrorResponse());
                    }
                    Verify2IndexActivity.this.getPadSub1.show();
        ...
        if (bArr4 != null) {
            ...
            while (true) {
                ...
                if (PngjBadSignature5 == null) {
                    f = 0.0f;
                    PngjBadSignature5 = com.d.e.a.PngjBadCrcException.PngjBadSignature((char) View.MeasureSpec.getMode(0), (SystemClock.currentThreadTimeMillis() > (-1L) ? 1 : (SystemClock.currentThreadTimeMillis() == (-1L) ? 0 : -1)) + 34, (ViewConfiguration.getScrollFriction() > 0.0f ? 1 : (ViewConfiguration.getScrollFriction() == 0.0f ? 0 : -1)) + 154, -1010806406, false, "g", new Class[]{Object.class, Object.class});
                } else {
                    f = 0.0f;
                }
            ...
            try {
                if (j2 != -1) {
                    ...
                    if (j3 >= ((Long) cls.getDeclaredMethod((String) objArr3[0], null).invoke(null, null)).longValue()) {
                        ...
                        values$1eba2e16 = new Object[]{new int[]{r6}, new int[1], r0, new int[]{r5}};
