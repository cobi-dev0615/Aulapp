...
public class getData extends Dialog {
    ...
    public class PngjBadSignature implements View.OnClickListener {
        ...
        public final void onClick(View view) {
            ...
            com.identy.a aVar = (com.identy.a) getData.this.PngjBadSignature.get(view.getTag());
            HashMap hashMap = getData.this.PngjBadCrcException;
            new Attempt(context, aVar, (hashMap == null || !hashMap.containsKey(view.getTag())) ? null : (com.identy.a) getData.this.PngjBadCrcException.get(view.getTag())).show();
        }
    }
    ...
    public getData(Activity activity, boolean z, HashMap<Pair<Hand, Finger>, com.identy.a> hashMap, HashMap<Pair<Hand, Finger>, com.identy.a> hashMap2, com.identy.d.PngjException pngjException) {
        super(activity);
    ...
    public void onCreate(Bundle bundle) {
        ...
        if (this.PngjBadSignature.containsKey(new Pair(hand, finger)) && b.b(hand, finger, this.PngjBadSignature) != null) {
            ((TextView) findViewById(R.id.left_index_nfig_score)).setText(Html.fromHtml(((com.identy.a) b.b(hand, finger, this.PngjBadSignature)).PngjBadCrcException()));
        }
        if (this.PngjBadSignature.containsKey(new Pair(hand2, finger)) && b.b(hand2, finger, this.PngjBadSignature) != null) {
            ((TextView) findViewById(R.id.right_index_nfig_score)).setText(Html.fromHtml(((com.identy.a) b.b(hand2, finger, this.PngjBadSignature)).PngjBadCrcException()));
        }
        ...
        if (this.PngjBadSignature.containsKey(new Pair(hand, finger)) && b.b(hand, finger, this.PngjBadSignature) != null) {
            ((TextView) findViewById(R.id.left_index_finger_score)).setText(Html.fromHtml(((com.identy.a) b.b(hand, finger, this.PngjBadSignature)).PngjException(false)));
        }
        if (!this.PngjBadSignature.containsKey(new Pair(hand, finger)) || b.b(hand, finger, this.PngjBadSignature) == null) {
            return;
        }
        ((TextView) findViewById(R.id.right_index_finger_score)).setText(Html.fromHtml(((com.identy.a) b.b(hand2, finger, this.PngjBadSignature)).PngjException(false)));
    }
}
