                    ...
                    new ActivityResultCallback<Uri>() {
                        ...
                        public void onActivityResult(Uri uri) {
                            if (uri != null) {
                                ...
                                g(false); // dismiss loading on cancel
                            }
                        }
                    });

    private void onGalleryPhotoSelected(Uri uri) {
        g(false); // dismiss loading
        ValidationFlowManager vfm = this.i;
        if (vfm != null) {
            vfm.moveToNextValidation();
        }
        j(); // continue to next validation step
    }
    ...
    */
    ...
    public final void j() {
        ...
        if (i == 1 || i == 2) {
            ...
            // or fingerprint scanning. Both validation steps now open the gallery.
            LoginObject loginObject = this.h;
            if (loginObject != null ? Intrinsics.areEqual(loginObject.getBiometricException(), Boolean.TRUE) : false) {
                // If biometric exception is set, skip this step entirely
        ...
        // Default: validation complete, proceed to home
        h();
    }
    ...
    public final void onViewCreated(View view, Bundle bundle) {
        ...
        if (fragmentFirstLoginBinding != null) {
            ...
            BuildersKt.launch(LifecycleOwnerKt.getLifecycleScope(viewLifecycleOwner), EmptyCoroutineContext.INSTANCE, CoroutineStart.DEFAULT, new y4(this, null));
            LifecycleOwner viewLifecycleOwner2 = getViewLifecycleOwner();
            Intrinsics.checkNotNullExpressionValue(viewLifecycleOwner2, "getViewLifecycleOwner(...)");
            BuildersKt.launch(LifecycleOwnerKt.getLifecycleScope(viewLifecycleOwner2), EmptyCoroutineContext.INSTANCE, CoroutineStart.DEFAULT, new b5(this, null));
            LifecycleOwner viewLifecycleOwner3 = getViewLifecycleOwner();
            Intrinsics.checkNotNullExpressionValue(viewLifecycleOwner3, "getViewLifecycleOwner(...)");
            BuildersKt.launch(LifecycleOwnerKt.getLifecycleScope(viewLifecycleOwner3), EmptyCoroutineContext.INSTANCE, CoroutineStart.DEFAULT, new e5(this, null));
            LifecycleOwner viewLifecycleOwner4 = getViewLifecycleOwner();
            Intrinsics.checkNotNullExpressionValue(viewLifecycleOwner4, "getViewLifecycleOwner(...)");
            BuildersKt.launch(LifecycleOwnerKt.getLifecycleScope(viewLifecycleOwner4), EmptyCoroutineContext.INSTANCE, CoroutineStart.DEFAULT, new i5(this, null));
            LifecycleOwner viewLifecycleOwner5 = getViewLifecycleOwner();
            Intrinsics.checkNotNullExpressionValue(viewLifecycleOwner5, "getViewLifecycleOwner(...)");
            BuildersKt.launch(LifecycleOwnerKt.getLifecycleScope(viewLifecycleOwner5), EmptyCoroutineContext.INSTANCE, CoroutineStart.DEFAULT, new l5(this, null));
