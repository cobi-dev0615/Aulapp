...
public final class WebviewFragment extends Fragment {
    ...
    static final /* synthetic */ KProperty[] $$delegatedProperties = {Reflection.mutableProperty1(new MutablePropertyReference1Impl(WebviewFragment.class, "isRegisterFlow", "isRegisterFlow()Z", 0))};
    ...
    /* package */ WebviewViewModel viewModel;
    /* package */ final String TAG = Reflection.getOrCreateKotlinClass(WebviewFragment.class).getSimpleName();
    ...
    public WebviewFragment() {
        ActivityResultLauncher<String> registerForActivityResult = registerForActivityResult(new ActivityResultContract<String, Boolean>() { // from class: androidx.activity.result.contract.ActivityResultContracts$RequestPermission
            ...
            public Intent createIntent(Context context, String input) {
                ...
                intent.putExtra("android.content.pm.extra.PERMISSION_NAMES", new String[]{input});
                return intent;
            }
    ...
    private final void onBackPressed() {
        OnBackPressedCallback onBackPressedCallback = new OnBackPressedCallback(true) { // from class: com.gse.aulapp.feature.biometrix.presentation.ui.WebviewFragment$onBackPressed$callback$1
