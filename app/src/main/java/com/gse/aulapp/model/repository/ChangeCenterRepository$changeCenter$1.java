...
@Metadata(d1 = {"\u0000\u0012\n\u0000\n\u0002\u0010\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\u0010\u0000\u001a\u00020\u0001*\u000e\u0012\n\u0012\b\u0012\u0004\u0012\u00020\u00040\u00030\u0002H\n"}, d2 = {"<anonymous>", BuildConfig.FLAVOR, "Lkotlinx/coroutines/flow/FlowCollector;", "Lcom/gse/aulapp/model/data/statusControl/ApiResult;", "Lcom/gse/aulapp/model/response/ChangeCenterResponse;"}, k = 3, mv = {2, 0, 0}, xi = 48)
@DebugMetadata(c = "com.gse.aulapp.model.repository.ChangeCenterRepository$changeCenter$1", f = "ChangeCenterRepository.kt", i = {0, 1, 2}, l = {26, 33, 46, 55}, m = "invokeSuspend", n = {"$this$flow", "$this$flow", "$this$flow"}, s = {"L$0", "L$0", "L$0"})
/* loaded from: classes.dex */
public final class ChangeCenterRepository$changeCenter$1 extends SuspendLambda implements Function2<FlowCollector<? super ApiResult<? extends ChangeCenterResponse>>, Continuation<? super Unit>, Object> {
    final /* synthetic */ Context $context;
    final /* synthetic */ ChangeCenterRequest $request;
    ...
    */
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ...
            if (apiService != null) {
                ChangeCenterRequest changeCenterRequest = this.$request;
                this.L$0 = flowCollector;
                this.label = 1;
                obj = apiService.changeCenter(changeCenterRequest, this);
            } else {
                response = null;
                if (response != null) {
