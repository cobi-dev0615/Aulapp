...
public final class PasswordRecoveryRepository$passwordRecovery$1 extends SuspendLambda implements Function2<FlowCollector<? super ApiResult<? extends PasswordRecoveryResponse>>, Continuation<? super Unit>, Object> {
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ...
            PasswordRecoveryRequest request = this.$request;
            this.L$0 = flowCollector;
            this.label = 1;
            obj = apiService.passwordRecovery(request, this);
        ...
        if (response.isSuccessful()) {
            PasswordRecoveryResponse responseObj = (PasswordRecoveryResponse) response.body();
            if (responseObj != null) {
