...
public final class SessionRepository$getSessionApi$1 extends SuspendLambda implements Function2<FlowCollector<? super ApiResult<? extends SessionInstructorResponse>>, Continuation<? super Unit>, Object> {
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ...
            SessionInstructorRequest request = this.$request;
            this.L$0 = flowCollector;
            this.label = 1;
            obj = apiService.getSessionInstructor(request, this);
        ...
        if (response.isSuccessful()) {
            SessionInstructorResponse responseObj = (SessionInstructorResponse) response.body();
            if (responseObj != null) {
