...
public interface HistoricRecordPermissionsChangeDao {
    Object deleteHistoricCustom(SimpleSQLiteQuery simpleSQLiteQuery, Continuation continuation);
    ...
    Object saveHistoric(HistoricRecordPermissionsChangeEntity historicRecordPermissionsChangeEntity, Continuation continuation);
}
