...
public final class SessionRepository$getSessionDataApi$1 extends SuspendLambda implements Function2<FlowCollector<? super ApiResult<? extends SessionExamResponse>>, Continuation<? super Unit>, Object> {
    ...
    public /* bridge */ /* synthetic */ Object invoke(FlowCollector<? super ApiResult<? extends SessionExamResponse>> flowCollector, Continuation<? super Unit> continuation) {
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ...
            SessionExamRequest request = this.$sessionExamRequest;
            this.L$0 = flowCollector;
            this.label = 1;
            obj = apiService.getSessionData(request, this);
        ...
        if (response.isSuccessful()) {
            SessionExamResponse responseObj = (SessionExamResponse) response.body();
            if (responseObj != null) {
