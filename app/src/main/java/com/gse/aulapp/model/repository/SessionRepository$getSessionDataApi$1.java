...
@Metadata(d1 = {"\u0000\u0012\n\u0000\n\u0002\u0010\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\u0010\u0000\u001a\u00020\u0001*\u000e\u0012\n\u0012\b\u0012\u0004\u0012\u00020\u00040\u00030\u0002H\n"}, d2 = {"<anonymous>", BuildConfig.FLAVOR, "Lkotlinx/coroutines/flow/FlowCollector;", "Lcom/gse/aulapp/model/data/statusControl/ApiResult;", "Lcom/gse/aulapp/model/response/SessionExamResponse;"}, k = 3, mv = {2, 0, 0}, xi = 48)
@DebugMetadata(c = "com.gse.aulapp.model.repository.SessionRepository$getSessionDataApi$1", f = "SessionRepository.kt", i = {0, 1, 2}, l = {112, 119, 131, 138}, m = "invokeSuspend", n = {"$this$flow", "$this$flow", "$this$flow"}, s = {"L$0", "L$0", "L$0"})
/* loaded from: classes.dex */
public final class SessionRepository$getSessionDataApi$1 extends SuspendLambda implements Function2<FlowCollector<? super ApiResult<? extends SessionExamResponse>>, Continuation<? super Unit>, Object> {
    final /* synthetic */ Context $context;
    final /* synthetic */ SessionExamRequest $sessionExamRequest;
    private /* synthetic */ Object L$0;
    int label;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public SessionRepository$getSessionDataApi$1(Context context, SessionExamRequest sessionExamRequest, Continuation continuation) {
    ...
    public /* bridge */ /* synthetic */ Object invoke(FlowCollector<? super ApiResult<? extends SessionExamResponse>> flowCollector, Continuation continuation) {
        return invoke2((FlowCollector<? super ApiResult<SessionExamResponse>>) flowCollector, continuation);
    }
    ...
    */
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ...
            if (apiService != null) {
                SessionExamRequest sessionExamRequest = this.$sessionExamRequest;
                this.L$0 = flowCollector;
                this.label = 1;
                obj = apiService.getSessionData(sessionExamRequest, this);
            } else {
                response = null;
                if (response != null) {
    ...
    public final Object invoke2(FlowCollector<? super ApiResult<SessionExamResponse>> flowCollector, Continuation continuation) {
