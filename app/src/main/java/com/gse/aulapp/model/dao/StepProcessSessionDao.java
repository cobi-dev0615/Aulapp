...
public interface StepProcessSessionDao {
    Object deleteSessionsOfSessionId(String str, Continuation continuation);

    Object getStepCustom(SimpleSQLiteQuery simpleSQLiteQuery, Continuation<? super List<StepProcessSessionEntity>> continuation);

    Object saveUpdateStep(StepProcessSessionEntity stepProcessSessionEntity, Continuation continuation);
}
