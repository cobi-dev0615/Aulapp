...
public interface SessionDao {
    Object deleteSessionById(List<String> list, Continuation continuation);

    Object deleteSessionCustom(SimpleSQLiteQuery simpleSQLiteQuery, Continuation continuation);

    Object deleteSessionsByDate(String str, Continuation continuation);
    ...
    Object getCountSessionIsPending(SimpleSQLiteQuery simpleSQLiteQuery, Continuation continuation);

    Object getEndEntryClassBySessionId(SimpleSQLiteQuery simpleSQLiteQuery, Continuation continuation);

    Object getIdSessionCustom(SimpleSQLiteQuery simpleSQLiteQuery, Continuation<? super List<String>> continuation);

    Object getSessionCustomSync(SimpleSQLiteQuery simpleSQLiteQuery, Continuation continuation);

    Object getStartEntryClassBySessionId(SimpleSQLiteQuery simpleSQLiteQuery, Continuation continuation);

    Object saveClassRoom(ClassRoomEntity classRoomEntity, Continuation continuation);

    Object saveLesson(LessonEntity lessonEntity, Continuation continuation);

    Object saveSession(SessionEntity sessionEntity, Continuation continuation);

    Object saveVehicle(VehicleEntity vehicleEntity, Continuation continuation);

    Object updateDateStartEntry(SimpleSQLiteQuery simpleSQLiteQuery, Continuation continuation);

    Object updateSessionBySessionId(SimpleSQLiteQuery simpleSQLiteQuery, Continuation continuation);
}
