    ...
    */
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ...
            if (apiService != null) {
                GetEnrollmentInformationRequest getEnrollmentInformationRequest = this.$request;
                this.L$0 = flowCollector;
                this.label = 1;
                obj = apiService.getEnrollmentInformation(getEnrollmentInformationRequest, this);
            } else {
                response = null;
                if (response != null) {
