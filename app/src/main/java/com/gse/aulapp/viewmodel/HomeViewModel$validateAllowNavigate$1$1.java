...
public final class HomeViewModel$validateAllowNavigate$1$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    ...
    public static final class AnonymousClass1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        ...
        public AnonymousClass1(SessionDto sessionDto, ConfigurationSessionDto configurationSessionDto, Date date, Date date2, Activity activity, Date date3, boolean z, boolean z2, HomeViewModel homeViewModel, NavController navController, ClassDateRecyclerAdapter classDateRecyclerAdapter, Continuation<? super AnonymousClass1> continuation) {
