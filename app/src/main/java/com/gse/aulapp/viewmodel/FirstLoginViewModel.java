...
public final class FirstLoginViewModel extends ViewModel {
    ...
    final MutableStateFlow<Status> _messagePasswordRecovery;
    final MutableSharedFlow<Status> _messageRefreshToken;
    final MutableSharedFlow<Status> _messageRefreshTokenCEA;
    ...
    RefreshTokenRepository tokenRefreshRepository;
