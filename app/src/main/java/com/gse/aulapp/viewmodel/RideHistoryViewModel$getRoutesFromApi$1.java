...
public final class RideHistoryViewModel$getRoutesFromApi$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    ...
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public RideHistoryViewModel$getRoutesFromApi$1(Context context, SessionInstructorRequest sessionInstructorRequest, RideHistoryViewModel rideHistoryViewModel, Continuation continuation) {
