...
public final class HomeViewModel$getSessionFromApiAndSave$1$2$emit$1<T> extends ContinuationImpl {
    Object L$0;
    Object L$1;
    Object L$2;
    int label;
    ...
    public HomeViewModel$getSessionFromApiAndSave$1$2$emit$1(HomeViewModel$getSessionFromApiAndSave$1.AnonymousClass2 anonymousClass2, Continuation continuation) {
        super(continuation);
