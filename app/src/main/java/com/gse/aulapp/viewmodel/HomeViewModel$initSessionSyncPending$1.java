...
public final class HomeViewModel$initSessionSyncPending$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    ...
    public static final class AnonymousClass1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        ...
        public AnonymousClass1(HomeViewModel homeViewModel, Context context, Menu menu, FragmentHomeBinding fragmentHomeBinding, boolean z, Continuation<? super AnonymousClass1> continuation) {
    ...
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public HomeViewModel$initSessionSyncPending$1(HomeViewModel homeViewModel, Context context, Menu menu, FragmentHomeBinding fragmentHomeBinding, boolean z, Continuation<? super HomeViewModel$initSessionSyncPending$1> continuation) {
        super(2, continuation);
        this.this$0 = homeViewModel;
        this.$context = context;
        this.$item = menu;
