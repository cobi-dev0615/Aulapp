...
public final class ClassInCourseViewModel$getSessionDataApi$1$1$emit$1<T> extends ContinuationImpl {
    ...
    public ClassInCourseViewModel$getSessionDataApi$1$1$emit$1(ClassInCourseViewModel$getSessionDataApi$1.AnonymousClass1 anonymousClass1, Continuation continuation) {
        super((Continuation) continuation);
        this.this$0 = (ClassInCourseViewModel$getSessionDataApi$1.AnonymousClass1<T>) anonymousClass1;
    }
