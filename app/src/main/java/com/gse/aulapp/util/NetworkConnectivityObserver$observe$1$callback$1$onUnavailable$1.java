...
@DebugMetadata(c = "com.gse.aulapp.util.NetworkConnectivityObserver$observe$1$callback$1$onUnavailable$1", f = "NetworkConnectivityObserver.kt", i = {}, l = {41}, m = "invokeSuspend", n = {}, s = {})
/* loaded from: classes.dex */
public final class NetworkConnectivityObserver$observe$1$callback$1$onUnavailable$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    final /* synthetic */ ProducerScope<ConnectivityObserver.Status> $$this$callbackFlow;
    int label;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    /* JADX WARN: Multi-variable type inference failed */
    public NetworkConnectivityObserver$observe$1$callback$1$onUnavailable$1(ProducerScope<? super ConnectivityObserver.Status> producerScope, Continuation continuation) {
