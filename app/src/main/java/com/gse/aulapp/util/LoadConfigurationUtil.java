...
public abstract class LoadConfigurationUtil {
    ...
    public static final class Companion {
        ...
        public final void saveParameterListOnPreference(Activity context) {
            ...
            try {
                BuildersKt__Builders_commonKt.launch$default(GlobalScope.INSTANCE, null, null, new LoadConfigurationUtil$Companion$saveParameterListOnPreference$1(context, null), 3, null);
            } catch (Exception e) {
