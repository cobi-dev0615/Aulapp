...
public final class DeviceSecurityCheckerUtil {
    ...
    public final boolean isEmulator() {
        ...
        contains$default = StringsKt__StringsKt.contains$default(MODEL, (CharSequence) "google_sdk", false, 2, (Object) null);
        if (contains$default) {
            return true;
        }
        Intrinsics.checkNotNullExpressionValue(MODEL, "MODEL");
        contains$default2 = StringsKt__StringsKt.contains$default(MODEL, (CharSequence) "Emulator", false, 2, (Object) null);
        if (contains$default2) {
            return true;
        }
        Intrinsics.checkNotNullExpressionValue(MODEL, "MODEL");
        contains$default3 = StringsKt__StringsKt.contains$default(MODEL, (CharSequence) "Android SDK built for x86", false, 2, (Object) null);
        if (contains$default3) {
            return true;
        }
        String MANUFACTURER = Build.MANUFACTURER;
        Intrinsics.checkNotNullExpressionValue(MANUFACTURER, "MANUFACTURER");
        contains$default4 = StringsKt__StringsKt.contains$default(MANUFACTURER, (CharSequence) "Genymotion", false, 2, (Object) null);
