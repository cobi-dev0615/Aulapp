...
public abstract class ControllerEntryOrExamUtil {
    ...
    public static final class Companion {
        ...
        public final void saveEntryExam(String dateEntryExam, String sessionID, SessionRepository repository) {
            ...
            try {
                BuildersKt__Builders_commonKt.launch$default(GlobalScope.INSTANCE, null, null, new ControllerEntryOrExamUtil$Companion$saveEntryExam$1(repository, dateEntryExam, sessionID, null), 3, null);
            } catch (Exception e) {
