...
public final class WebviewViewModel extends ViewModel {
    private final MutableSharedFlow<BiometricResult> _responseBiometric;
    private final SharedFlow<BiometricResult> responseBiometric;
    private final String TAG = Reflection.getOrCreateKotlinClass(WebviewViewModel.class).getSimpleName();
