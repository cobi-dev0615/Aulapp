...
public abstract class PngjBadCrcException {
    ...
    */
    ...
    /* JADX WARN: Code restructure failed: missing block: B:16:0x0034, code lost:
        ...
        r6 = (-r6) + r7;
        com.d.e.a.PngjBadCrcException.$16 = (com.d.e.a.PngjBadCrcException.$17 + 29) % kotlin.uuid.Uuid.SIZE_BITS;
        r7 = r8;
        r8 = r0;
        r0 = r2;
        r2 = r3;
    ...
    */
    ...
    public static Object PngjBadSignature(int i) {
        int i2 = $10;
        $11 = ((i2 ^ 65) + ((i2 & 65) << 1)) % Uuid.SIZE_BITS;
    ...
    public static Object PngjBadSignature(char c, int i, int i2, int i3, boolean z, String str, Class[] clsArr) {
        ...
        try {
            ...
            if (str == null) {
                ...
                int i5 = $11;
                $10 = ((i5 & 107) + (i5 | 107)) % Uuid.SIZE_BITS;
            } else if (clsArr == null) {
                if (z) {
                    int i6 = $10;
