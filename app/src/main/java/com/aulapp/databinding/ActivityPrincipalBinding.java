...
public final class ActivityPrincipalBinding {
    ...
    private ActivityPrincipalBinding(DrawerLayout drawerLayout, AppBarMainBinding appBarMainBinding, DrawerLayoutBinding drawerLayoutBinding, DrawerLayout drawerLayout2, NavigationView navigationView) {
        ...
        if (findChildViewById != null) {
            ...
            if (findChildViewById2 != null) {
                ...
                if (navigationView != null) {
                    return new ActivityPrincipalBinding(drawerLayout, bind, bind2, drawerLayout, navigationView);
                }
            }
        }
