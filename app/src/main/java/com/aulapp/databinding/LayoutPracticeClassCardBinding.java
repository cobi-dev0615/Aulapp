...
public final class LayoutPracticeClassCardBinding {
    public final ConstraintLayout clClassCard;
    public final ConstraintLayout clClassDetailCardTitle;
    public final CardView classDetailCard;
    public final CardView cvPracticeClassClassCard;
    ...
    private LayoutPracticeClassCardBinding(ConstraintLayout constraintLayout, ConstraintLayout constraintLayout2, ConstraintLayout constraintLayout3, CardView cardView, CardView cardView2, LayoutClassProgressTextBinding layoutClassProgressTextBinding, LayoutClassProgressTextBinding layoutClassProgressTextBinding2, LayoutClassProgressTextBinding layoutClassProgressTextBinding3, LayoutClassProgressTextBinding layoutClassProgressTextBinding4, LayoutClassProgressTextBinding layoutClassProgressTextBinding5, LayoutClassProgressTextBinding layoutClassProgressTextBinding6, LayoutClassProgressTextBinding layoutClassProgressTextBinding7, LayoutClassProgressTextBinding layoutClassProgressTextBinding8, LayoutClassProgressTextBinding layoutClassProgressTextBinding9, LayoutClassProgressTextBinding layoutClassProgressTextBinding10, LayoutClassProgressTextBinding layoutClassProgressTextBinding11, LayoutClassProgressTextBinding layoutClassProgressTextBinding12, LayoutClassProgressTextBinding layoutClassProgressTextBinding13, ImageView imageView, LinearLayout linearLayout, TextView textView) {
        ...
        this.lnClassCard = linearLayout;
        this.tvPracticeClassTitleClassCard = textView;
    }

    public static LayoutPracticeClassCardBinding bind(View view) {
        ...
        if (constraintLayout != null) {
            ...
            if (constraintLayout2 != null) {
                ...
                CardView cardView = (CardView) ViewBindings.findChildViewById(view, R.id.class_detail_card);
                if (cardView != null) {
                    i = R.id.cv_practice_class_class_card;
                    CardView cardView2 = (CardView) ViewBindings.findChildViewById(view, R.id.cv_practice_class_class_card);
                    if (cardView2 != null) {
                                                                    ...
                                                                    if (findChildViewById12 != null) {
                                                                        ...
                                                                        if (findChildViewById13 != null) {
                                                                            ...
                                                                            if (imageView != null) {
                                                                                ...
                                                                                LinearLayout linearLayout = (LinearLayout) ViewBindings.findChildViewById(view, R.id.ln_class_card);
                                                                                if (linearLayout != null) {
                                                                                    ...
                                                                                    if (textView != null) {
                                                                                        return new LayoutPracticeClassCardBinding((ConstraintLayout) view, constraintLayout, constraintLayout2, cardView, cardView2, bind, bind2, bind3, bind4, bind5, bind6, bind7, bind8, bind9, bind10, bind11, bind12, bind13, imageView, linearLayout, textView);
                                                                                    }
                                                                                }
                                                                            }
                                                                        }
