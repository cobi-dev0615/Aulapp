...
public final class ClassPracticeBeforeViewModel$getSessionById$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    ...
    public static final class AnonymousClass1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        ...
        public AnonymousClass1(ClassPracticeBeforeViewModel classPracticeBeforeViewModel, String str, Continuation<? super AnonymousClass1> continuation) {
    ...
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public ClassPracticeBeforeViewModel$getSessionById$1(ClassPracticeBeforeViewModel classPracticeBeforeViewModel, String str, Continuation<? super ClassPracticeBeforeViewModel$getSessionById$1> continuation) {
        super(2, continuation);
        this.this$0 = classPracticeBeforeViewModel;
        this.$sessionID = str;
    }
