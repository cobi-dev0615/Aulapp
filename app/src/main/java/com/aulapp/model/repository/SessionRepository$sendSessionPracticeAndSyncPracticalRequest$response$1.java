...
public final class SessionRepository$sendSessionPracticeAndSyncPracticalRequest$response$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Deferred<? extends Response<SessionPracticeExamResponse>>>, Object> {
    ...
    public static final class AnonymousClass1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Response<SessionPracticeExamResponse>>, Object> {
        ...
        public AnonymousClass1(Context context, SessionPracticeSyncRequest sessionPracticeSyncRequest, Continuation<? super AnonymousClass1> continuation) {
    ...
    @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        SessionRepository$sendSessionPracticeAndSyncPracticalRequest$response$1 sessionRepository$sendSessionPracticeAndSyncPracticalRequest$response$1 = new SessionRepository$sendSessionPracticeAndSyncPracticalRequest$response$1(this.$context, this.$practiceRequest, continuation);
        sessionRepository$sendSessionPracticeAndSyncPracticalRequest$response$1.L$0 = obj;
        return sessionRepository$sendSessionPracticeAndSyncPracticalRequest$response$1;
    }
    ...
    public final Object invoke2(CoroutineScope coroutineScope, Continuation<? super Deferred<Response<SessionPracticeExamResponse>>> continuation) {
        return ((SessionRepository$sendSessionPracticeAndSyncPracticalRequest$response$1) create(coroutineScope, continuation)).invokeSuspend(Unit.INSTANCE);
    }
}
