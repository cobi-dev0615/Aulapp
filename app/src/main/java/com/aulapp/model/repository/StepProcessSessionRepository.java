...
public final class StepProcessSessionRepository {
    ...
    public final Object saveUpdateStepProcessSession(String str, EnumIdStepperMenu enumIdStepperMenu, EnumStatusStepSession enumStatusStepSession, boolean z, Continuation<? super Unit> continuation) {
        Object saveUpdateStep = this.dao.saveUpdateStep(new StepProcessSessionEntity(str, EnumIdStepperMenu.name$default(enumIdStepperMenu, null, 1, null), enumStatusStepSession.name(), z), continuation);
