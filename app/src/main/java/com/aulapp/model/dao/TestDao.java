...
public interface TestDao {
    Object getTestBySessionID(String str, Continuation<? super TestEntity> continuation);

    Object insert(TestEntity testEntity, Continuation<? super Unit> continuation);
}
