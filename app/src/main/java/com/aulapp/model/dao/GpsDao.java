...
public interface GpsDao {
    Object deleteGpsTraceBySessionID(String str, Continuation<? super Unit> continuation);

    Object getAllGpsTraceCustom(SimpleSQLiteQuery simpleSQLiteQuery, Continuation<? super List<GpsTraceEntity>> continuation);

    Object getSpeedCustom(SimpleSQLiteQuery simpleSQLiteQuery, Continuation<? super Double> continuation);

    Object saveGpsTrace(GpsTraceEntity gpsTraceEntity, Continuation<? super Long> continuation);
}
