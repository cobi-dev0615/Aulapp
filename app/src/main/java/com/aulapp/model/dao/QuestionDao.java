...
public interface QuestionDao {
    Object deleteAllQuestionOfTestID(String str, Continuation<? super Unit> continuation);

    Object getQuestionsByTestID(String str, Continuation<? super List<QuestionEntity>> continuation);

    Object insert(QuestionEntity questionEntity, Continuation<? super Unit> continuation);

    Object updateQuestionApproved(String str, String str2, String str3, Continuation<? super Unit> continuation);
}
