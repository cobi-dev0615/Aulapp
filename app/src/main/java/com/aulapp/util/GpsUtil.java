...
public abstract class GpsUtil {
    ...
    public static final class Companion {
        ...
        public final void traceRouteOnMaps(List<Pair<Double, Double>> coordinates, Context context) {
            ...
            drop2 = CollectionsKt___CollectionsKt.drop(arrayList2, 1);
            zip = CollectionsKt___CollectionsKt.zip(drop, drop2);
            joinToString$default = CollectionsKt___CollectionsKt.joinToString$default(zip, "|", null, null, 0, null, null, 62, null);
