...
public abstract class GpsTracerUtil {
    ...
    public static final class Companion {
        ...
        public final GpsCalculateDataDto calculateTotalDistanceStoppedAndMovingTime(List<LocationDto> locations) {
            ...
            sortedWith = CollectionsKt___CollectionsKt.sortedWith(locations, new Comparator() { // from class: com.gse.aulapp.util.GpsTracerUtil$Companion$calculateTotalDistanceStoppedAndMovingTime$$inlined$sortedBy$1
