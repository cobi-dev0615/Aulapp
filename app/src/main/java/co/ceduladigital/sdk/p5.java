...
public final class p5 implements NavDirections {
    public final UserInfoDto a;

    public p5(UserInfoDto userInfo) {
    ...
    public final boolean equals(Object obj) {
        ...
        return (obj instanceof p5) && Intrinsics.areEqual(this.a, ((p5) obj).a);
    }

    @Override // androidx.navigation.NavDirections
    public final int getActionId() {
        return R.id.action_firstLoginFragment_to_fingerPrintBiometricFragment;
    }
    ...
    public final String toString() {
        return "ActionFirstLoginFragmentToFingerPrintBiometricFragment(userInfo=" + this.a + ")";
    }
}
