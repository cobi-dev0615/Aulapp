...
public final class j2 extends SuspendLambda implements Function2 {
    ...
    public j2(Status status, ClassPracticeBeforeFragment classPracticeBeforeFragment, Continuation continuation) {
    ...
    public final Continuation create(Object obj, Continuation continuation) {
        return new j2(this.c, this.b, continuation);
    }
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ...
            i2 i2Var = new i2(this.c, classPracticeBeforeFragment, null);
            this.a = 1;
            if (RepeatOnLifecycleKt.repeatOnLifecycle(viewLifecycleOwner, state, i2Var, this) == coroutine_suspended) {
