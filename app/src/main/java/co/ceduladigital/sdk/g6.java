...
public final class g6 implements NavDirections {
    public final String a;
    public final EnumClassType b;

    public g6(String sessionID, EnumClassType sessionType) {
    ...
    public final boolean equals(Object obj) {
        ...
        g6 g6Var = (g6) obj;
        return Intrinsics.areEqual(this.a, g6Var.a) && this.b == g6Var.b;
    }

    @Override // androidx.navigation.NavDirections
    public final int getActionId() {
        return R.id.action_homeFragment_to_classPracticeBeforeFragment;
    }
    ...
    public final int hashCode() {
        return this.b.hashCode() + defpackage.a.g(true, this.a.hashCode() * 31, 31);
    }

    public final String toString() {
        return "ActionHomeFragmentToClassPracticeBeforeFragment(sessionID=" + this.a + ", isEnter=true, sessionType=" + this.b + ")";
    }
}
