...
public final class m7 extends SuspendLambda implements Function2 {
    ...
    public m7(PracticeClassFragment practiceClassFragment, Continuation continuation) {
    ...
    public final Continuation create(Object obj, Continuation continuation) {
        return new m7(this.b, continuation);
    }
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ...
            l7 l7Var = new l7(practiceClassFragment, null);
            this.a = 1;
            if (RepeatOnLifecycleKt.repeatOnLifecycle(viewLifecycleOwner, state, l7Var, this) == coroutine_suspended) {
