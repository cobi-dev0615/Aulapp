...
public final class z1 extends SuspendLambda implements Function2<Object, Object, Object> {
    public int a;
    public final /* synthetic */ ClassPracticeBeforeFragment b;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public z1(ClassPracticeBeforeFragment classPracticeBeforeFragment, Continuation continuation) {
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ...
            SharedFlow<Status> message = classPracticeBeforeViewModel.getMessage();
            y1 y1Var = new y1(classPracticeBeforeFragment);
            this.a = 1;
            if (message.collect(y1Var, this) == coroutine_suspended) {
