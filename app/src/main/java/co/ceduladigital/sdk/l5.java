...
public final class l5 extends SuspendLambda implements Function2<Object, Object, Object> {
    public int a;
    public final /* synthetic */ FirstLoginFragment b;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public l5(FirstLoginFragment firstLoginFragment, Continuation continuation) {
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ...
            k5 k5Var = new k5(firstLoginFragment, null);
            this.a = 1;
            if (RepeatOnLifecycleKt.repeatOnLifecycle(viewLifecycleOwner, state, k5Var, this) == coroutine_suspended) {
