...
public final class s0 extends SuspendLambda implements Function2<Object, Object, Object> {
    public int a;
    public final /* synthetic */ ClassInCourseFragment b;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public s0(ClassInCourseFragment classInCourseFragment, Continuation continuation) {
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ...
            StateFlow<Boolean> isTimeForAlarm = classInCourseViewModel.isTimeForAlarm();
            r0 r0Var = new r0(classInCourseFragment, 0);
            this.a = 1;
            if (isTimeForAlarm.collect(r0Var, this) == coroutine_suspended) {
