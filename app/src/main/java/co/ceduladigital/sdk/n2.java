...
public final class n2 implements NavDirections {
    ...
    public n2(String sessionID, String str, ConfigurationSessionDto configurationSession) {
    ...
    public final boolean equals(Object obj) {
        ...
        n2 n2Var = (n2) obj;
        return Intrinsics.areEqual(this.a, n2Var.a) && Intrinsics.areEqual(this.b, n2Var.b) && Intrinsics.areEqual(this.c, n2Var.c);
    }

    @Override // androidx.navigation.NavDirections
    public final int getActionId() {
        return R.id.action_classPracticeBeforeFragment_to_practiceClassFragment;
    }
    ...
    public final String toString() {
        return "ActionClassPracticeBeforeFragmentToPracticeClassFragment(sessionID=" + this.a + ", entryTime=" + this.b + ", configurationSession=" + this.c + ")";
    }
}
