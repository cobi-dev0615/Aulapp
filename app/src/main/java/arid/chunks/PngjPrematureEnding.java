...
public final class PngjPrematureEnding extends e1 {
    ...
    public final PngjInputException.values PngjBadCrcException() {
        return Enum.valueOf(PngjInputException.values.class, "BEFORE_IDAT");
    }

    @Override // arid.chunks.PngjInputException
    public final PngjBadSignature values() {
        PngjBadSignature pngjBadSignature = new PngjBadSignature(9, arid.chunks.valueOf.PngjBadSignature(this.PngjBadSignature), true);
